    ...
    <div className="flex flex-col items-center bg-gray-100 p-8 rounded-xl shadow-md border border-gray-200">
      {!loading && (
        <>
          ...
          <label
            htmlFor="file-upload"
            className="group flex items-center px-6 py-3 rounded-lg bg-purple-600 text-white cursor-pointer hover:bg-blue-700 transition-all duration-200 ease-in-out shadow-sm hover:shadow-md mb-2"
          >
