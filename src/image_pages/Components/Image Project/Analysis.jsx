    ...
    >
      ...
      <div className="flex items-center space-x-6 mb-10">
        ...
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-300">Created on {formattedDate}</p>
        </div>
      </div>
            ...
            <div className="flex items-center">
              ...
              <div className="relative group ml-2">
                ...
                <div className=" h-20 mt-14 left-[60%] absolute z-20 hidden group-hover:block px-4 py-2 text-xs text-gray-900 bg-gray-100 dark:text-white dark:bg-gray-700 rounded-lg shadow-lg -translate-y-10  top-0 w-72 transition-all duration-200 opacity-0 group-hover:opacity-100">
                  <p className="mb-1">• The graph shows each class and its count.</p>
          ...
          <div className="p-6">
            {sorted_class.length > 0 ? (
              <>
                ...
                <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                  <div className="flex items-center mb-3">
                    <h3 className="font-semibold text-gray-800 dark:text-gray-200">Class Insights</h3>
                    <div className="relative group ml-2">
                      ...
                      <div className="absolute z-20 hidden group-hover:block px-4 py-2 text-xs text-gray-900 bg-gray-100 dark:text-white dark:bg-gray-700 rounded-lg shadow-lg translate-x-1/5 -translate-y-full left-1/2 top-0 w-64 transition-all duration-200 opacity-0 group-hover:opacity-100">
                        <p className="mb-1">• Balanced: Near the median.</p>
                        <p className="mb-1">• Underbalanced: Below the median.</p>
                        <p className="mb-1">• Overbalanced: Above the median.</p>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                    {categorizedClasses.map((item) => (
                      <div key={item.class_name} className="flex items-center text-sm">
                        <span
                          className="inline-block w-3 h-3 rounded-full mr-2 flex-shrink-0"
                          style={{ backgroundColor: item.Color }}
                        ></span>
                        <span className="font-medium">{item.class_name}:</span>
                        <span className="ml-1 text-gray-600 dark:text-gray-300">{item.count} annotations</span>
                        <span className="ml-1 text-xs px-2 py-0.5 rounded-full bg-gray-200 dark:bg-gray-600">{item.balanceType}</span>
                      </div>
                    ))}
                  </div>
                </div>
              ...
              <div className="flex flex-col items-center justify-center py-12 text-center">
                ...
                <div className="text-lg font-semibold text-gray-700 dark:text-gray-300">No Annotations Done Yet.</div>
                <p className="text-sm text-gray-500 dark:text-gray-400 mt-2">Start annotating your images to see class statistics.</p>
              </div>
            )}
          </div>
        </div>
            ...
            <div className="px-6 py-1 border-b border-gray-200 dark:border-gray-700">
              <div className="flex items-center">
                ...
                <div className="relative group ml-2">
                  <HiOutlineQuestionMarkCircle className="text-gray-500 dark:text-gray-400" />
                  <div className=" h-20 mt-14 left-[60%] absolute z-20 hidden group-hover:block px-4 py-2 text-xs text-gray-900 bg-gray-100 dark:text-white dark:bg-gray-700 rounded-lg shadow-lg -translate-y-10  top-0 w-72 transition-all duration-200 opacity-0 group-hover:opacity-100">
                    <p className="mb-1">• Displays the total number of images.</p>
              ...
              <div className="grid grid-cols-3 gap-4">
                <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4">
                  <div className="flex flex-col items-center">
                    <div className="text-blue-600 dark:text-blue-400 text-3xl font-bold mb-2">{totalImages}</div>
                    <div className="text-sm text-gray-600 dark:text-gray-400 text-center">Images Uploaded</div>
                  </div>
                </div>
                <div className="bg-green-50 dark:bg-green-900/20 rounded-lg p-4">
                  <div className="flex flex-col items-center">
                    <div className="text-green-600 dark:text-green-400 text-3xl font-bold mb-2">{imagesAnnotated}</div>
                    <div className="text-sm text-gray-600 dark:text-gray-400 text-center">Images Annotated</div>
                  </div>
                </div>
                <div className="bg-red-50 dark:bg-red-900/20 rounded-lg p-4">
                  <div className="flex flex-col items-center">
                    <div className="text-red-600 dark:text-red-400 text-3xl font-bold mb-2">{imagesWithoutAnnotation}</div>
                    <div className="text-sm text-gray-600 dark:text-gray-400 text-center">Without Annotation</div>
                  </div>
                </div>
              </div>
            </div>
