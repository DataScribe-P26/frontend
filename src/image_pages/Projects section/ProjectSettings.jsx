        ...
        <div className="flex-1 p-8">
          {activeSection === 'general' && (
            <div className="space-y-6">
              ...
              <p className="text-gray-600 dark:text-gray-300">Manage the basic details of your project.</p>
                ...
                {members.map((member, index) => (
                  <div key={index} className="flex justify-between items-center border p-3 rounded-md bg-gray-50 dark:bg-gray-700">
                    ...
                    <div className="flex space-x-3">
                      <button onClick={() => setRoleToEdit(index)} className="text-purple-600">
                        <FiEdit3 />
                      </button>
                      <button onClick={() => setMembers(members.filter((_, i) => i !== index))} className="text-red-500">
                        <FiTrash />
                      </button>
                    </div>
                  </div>
          ...
          {activeSection === 'permissions' && (
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-300">Manage permissions here.</p>
            </div>
          )}
        </div>
      </div>
