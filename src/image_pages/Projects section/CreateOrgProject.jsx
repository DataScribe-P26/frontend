        ...
        <div className="p-5">
          {step === 1 ? (
            ...
            <div className="flex gap-8 dark:bg-gray-900 dark:text-gray-100">
              <div className="w-1/2">
                <h3 className="text-lg font-semibold mb-4 dark:bg-gray-900 dark:text-gray-100">
                  Available Members
                </h3>
                  ...
                  {(searchQuery ? searchResults : availableMembers).map(
                    (member) => (
                      ...
                      >
                        ...
                        <button className="bg-purple-600 text-white hover:bg-blue-900 dark:bg-red-700 rounded-lg px-2  dark:text-white dark:hover:bg-red-900 ">
                          Add
                        </button>
                      </div>
                    )
