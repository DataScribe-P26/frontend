      ...
      <div className="relative">
        <div className="container px-0 pt-0 pb-40 relative z-10 mr-0">
          <div className="max-w-2xl ml-6">
            ...
            >
              At DataScribe.ai, we simplify and accelerate the data annotation
              process using cutting-edge AI technology. Our auto-annotation
              platform enables users to upload hundreds of images, annotate a
              few, and let AI handle the rest—boosting efficiency while
        ...
        <div className="absolute top-0 right-0 w-1/2 h-full overflow-hidden">
          <div
            className={`absolute top-0 right-0 w-full h-full bg-purple-600/90 dark:bg-purple-800/90
              ...
              ${
                isLoaded
                  ? "translate-x-1/3 scale-100 opacity-100"
