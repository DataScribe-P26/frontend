  ...
  return (
    ...
    >
      <div className="bg-gray-200 p-6 rounded-lg shadow-xl max-w-xl mx-auto">
        ...
        <p className="text-gray-600 mb-4">Upload image files or folders.</p>
        ...
        <p className="text-gray-600 mb-4">
          Use tools like Rectangle, Polygon, or Segmentation Mask to draw
          annotations and assign class labels.
        </p>

        <h3 className="text-xl font-semibold text-gray-900 mb-2">
          5. Manage Class Labels
        </h3>
        <p className="text-gray-600 mb-4">
