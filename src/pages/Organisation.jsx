...
import { Settings, ExternalLink, Plus, X, ArrowRight, ArrowLeft, Search, Trash2 } from 'lucide-react';
...
const OrganizationIllustration = () => (
  <svg viewBox="0 0 240 240" className="w-full" xmlns="http://www.w3.org/2000/svg">
    ...
    {/* Background elements */}
    <circle cx="120" cy="120" r="90" fill="url(#lightPurpleGrad)" className="animate-pulse"/>
    <circle cx="120" cy="120" r="75" fill="none" stroke="#E9D5FF" strokeWidth="2" strokeDasharray="4 4"/>

    {/* Central organization symbol */}
    <g transform="translate(95, 85)">
      <rect x="0" y="20" width="50" height="60" fill="url(#purpleGrad)" rx="4"/>
    ...
    <g className="animate-bounce" style={{ animationDuration: '3s' }}>
      <rect x="40" y="70" width="24" height="24" fill="#9333EA" rx="4" transform="rotate(-15, 52, 82)"/>
    ...
    <g className="animate-bounce" style={{ animationDuration: '2.5s' }}>
      <rect x="176" y="70" width="24" height="24" fill="#9333EA" rx="4" transform="rotate(15, 188, 82)"/>
    ...
    <g transform="translate(40, 140)">
      <circle cx="0" cy="0" r="15" fill="#9333EA" className="animate-ping opacity-20"/>
      <circle cx="0" cy="-8" r="8" fill="#7E22CE"/>
      <path d="M-8 2 C-8 2 0 12 8 2 L8 16 L-8 16 L-8 2" fill="#7E22CE"/>
      <line x1="15" y1="0" x2="40" y2="0" stroke="#9333EA" strokeWidth="2" strokeDasharray="3 3"/>
    </g>
    ...
    <g transform="translate(120, 40)">
      ...
      <circle cx="0" cy="-8" r="8" fill="#7E22CE"/>
      <path d="M-8 2 C-8 2 0 12 8 2 L8 16 L-8 16 L-8 2" fill="#7E22CE"/>
      <line x1="0" y1="20" x2="0" y2="35" stroke="#9333EA" strokeWidth="2" strokeDasharray="3 3"/>
    </g>
...
const slideUpAnimation = "animate-[slideUp_0.3s_ease-out]";
  ...
  const isFirstStepValid = orgData.name.trim() !== '' && orgData.description.trim() !== '';
  ...
  if (!isOpen) return null;
   ...
   return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
      <div className={`bg-white rounded-lg shadow-xl w-full max-w-4xl mx-4 my-6 ${fadeInAnimation}`}>
        {/* Header */}
            ...
            <div className={`flex gap-8 ${slideUpAnimation}`}>
              ...
              <div className="w-1/2 flex flex-col items-center justify-center p-6 bg-purple-50 rounded-lg">
                ...
                <div className="text-center mt-6">
                  <h3 className="text-lg font-semibold text-purple-800">Build Your Organization</h3>
                  <p className="text-sm text-purple-600 mt-2">Create a space for your team to collaborate and annotate together</p>
                </div>
              </div>
            ...
            <div className="space-y-5">
              ...
              <div className="flex gap-5" style={{ height: '300px' }}>
                ...
                <div className="flex-1">
                  <h3 className="text-sm font-medium text-gray-900 mb-2">Available Users</h3>
                  <div className="border rounded-lg overflow-y-auto" style={{ maxHeight: '260px' }}>
                    ...
                    {!searchQuery && (
                      <p className="px-4 py-2 text-gray-500">Type to search users</p>
                    )}
                  </div>
                </div>
                ...
                {/* Selected Members */}
                <div className="flex-1">
                  <h3 className="text-sm font-medium text-gray-900 mb-2">Selected Members</h3>
                  <div className="border rounded-lg overflow-y-auto" style={{ maxHeight: '260px' }}>
                    {selectedMembers.length > 0 ? (
                      <div className="space-y-2 p-2">
                        {selectedMembers.map(member => (
                          <div key={member.id} className="flex items-center justify-between bg-purple-50 p-2 rounded-lg">
                            <div>
                      ...
                      <p className="px-4 py-2 text-gray-500 ">No members selected</p>
                    )}
                  </div>
                </div>
              </div>
...
const OrganizationsPage = () => {
  ...
  return (
    <div className="p-8">
      ...
      <CreateOrganizationModal isOpen={showModal} onClose={() => setShowModal(false)} />
    </div>
  );
};
