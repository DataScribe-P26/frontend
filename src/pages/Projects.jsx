              ...
              <div className="space-y-5">
                ...
                <div className="group">
                  ...
                  <textarea
                    ...
                    onChange={handleInputChange}
                    rows={4}
                    className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all duration-300 resize-none"
...
const ProjectsPage = () => {
  ...
  const [projects, setProjects] = useState([
    { id: 1, name: "AI Annotation Tool", status: "In Progress" },
    { id: 2, name: "E-Green Tech", status: "Completed" },
    { id: 3, name: "FastAPI Auth System", status: "Pending Review" },
  ]);
