...
const LandingPage = () => {
  ...
  const imageFeatures = [
    {
      ...
      description:
        "Our advanced AI models can identify and track objects with exceptional precision, even in complex scenes. Perfect for automated inventory management, security monitoring, and quality control applications.",
    },
    {
      id: 2,
      ...
      description:
        "Go beyond basic detection with pixel-perfect segmentation that separates each object from its background. Ideal for medical imaging, autonomous navigation, and advanced image analysis tasks.",
    },
    {
      id: 3,
      ...
      description:
        "Identify specific points of interest within objects for precise tracking and analysis. Essential for pose estimation, facial recognition, and motion tracking applications.",
    },
    {
      id: 4,
      ...
      description:
        "Leverage powerful statistical tools to extract meaningful insights from your annotations. Automatically generate reports on object frequency, size distribution, and spatial relationships.",
    },
  ];
  ...
  const textFeatures = [
    {
      ...
      description:
        "Automatically identify and classify key entities in your text such as names, organizations, locations, dates, and more. Perfect for document processing, information extraction, and content analysis.",
    },
    {
      id: 2,
      ...
      description:
        "Understand the emotional tone behind text with advanced sentiment analysis. Track customer feedback, monitor brand perception, and analyze social media engagement with precision.",
    },
    {
      id: 3,
      ...
      description:
        "Automatically categorize documents and text into predefined classes for efficient organization and retrieval. Streamline your document management workflow with AI-powered classification.",
    },
    {
      id: 4,
      ...
      description:
        "Break language barriers with our advanced neural translation capabilities. Annotate text in one language and seamlessly convert it to others while maintaining context and meaning.",
    },
  ];
  ...
  return (
    <div className="min-h-screen overflow-auto bg-white">
      ...
      <nav className="bg-white/80 backdrop-blur-md shadow-sm fixed w-full z-40">
        <div className="container mx-auto px-2 py-2 flex justify-between items-center">
          <div className="flex items-center justify-between">
            ...
            <h1 className="text-2xl font-bold px-4 py-2 text-purple-900 ml-2">
              Datascribe.ai
            </h1>
          </div>
          <div className="hidden md:flex space-x-6">
            <a
              href="#features"
              className="px-4 py-2 text-purple-600 hover:text-purple-900 transition-colors"
            >
              Features
            </a>
            <a
            ...
            <Link
              to="/price"
              className="px-4 py-2 text-purple-600 hover:text-purple-900 transition-colors cursor-pointer"
            >
              Pricing
            </Link>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-purple-700 mb-8">
              Accelerate your ML pipeline with advanced image and text
              annotation
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="feature-card bg-white p-6 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300">
              ...
              <p className="text-purple-700">
                Built-in version control for your annotation projects with full
                history tracking.
              </p>
            </div>
            <div className="feature-card bg-white p-6 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300">
              ...
              <p className="text-purple-700">
                Process thousands of files simultaneously with our distributed
                architecture.
              </p>
            </div>
            <div className="feature-card bg-white p-6 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300">
              ...
              <p className="text-purple-700">
                Real-time insights into your annotation projects with advanced
                analytics.
              </p>
            </div>
          </div>
      ...
      <section
        id="features"
        className="py-16 bg-gradient-to-b from-purple-50/50 to-white"
      >
        <div className="container mx-auto px-4">
          {/* Heading */}
            ...
            {[
              {
                ...
                desc: "Process thousands of annotations per hour",
              },
              {
                icon: Lock,
                title: "Secure Infrastructure",
                desc: "Enterprise-grade security with encryption",
              },
              {
                icon: Settings,
                title: "Custom Models",
                desc: "Support for custom model integration",
              },
            ].map((benefit, index) => (
              <div
                key={index}
