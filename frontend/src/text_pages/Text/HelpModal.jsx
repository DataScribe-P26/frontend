  ...
  return (
    <Modal open={isOpen} onClose={onClose} center classNames={{ modal: "customModal" }}>
      <div className="bg-gray-200 p-6 rounded-lg shadow-xl max-w-xl mx-auto">
        <h2 className="text-3xl font-bold mb-4 text-purple-700">How to proceed?</h2>
        <p className="mb-6 text-gray-700">
          Here is a step-by-step guide on how to use the text annotation feature.
        </p>
        
        <h3 className="text-xl font-semibold text-gray-900 mb-2">1. Create Project and Upload a File</h3>
        <p className="text-gray-600 mb-4">
          Begin by creating project and then uploading the text file you want to annotate by selecting the "Import " option under Dataset in the sidebar.
        </p>
        
        <h3 className="text-xl font-semibold text-gray-900 mb-2">2. Create Labels</h3>
        <p className="text-gray-600 mb-4">
          Use "Label" tab in the sidebar.
        </p>
        
        <h3 className="text-xl font-semibold text-gray-900 mb-2">3. Start Annotation</h3>
        <p className="text-gray-600 mb-4">
          Navigate to the "Start Annotation" section where you can select text and assign labels.
        </p>
